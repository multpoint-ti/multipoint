...
export default function Address() {
    return (
        <section className="flex flex-col lg:flex-row gap-20 items-center pt-10 pb-6">
            ...
            <div className='flex flex-col gap-2 items-center lg:items-start lg:w-1/2 text-center lg:text-start'>
                ...
                <p className="text-base md:text-lg">
                    Estamos localizados na Rua São Paulo, 473 - Jardim Planalto, Registro - SP. CEP: 11900-000.
                </p>
                <div className="lg:mt-4 gap-4 flex">
